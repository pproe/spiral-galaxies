...
# File Locations
INPUT_IMAGES_DIRECTORIES = [r"E:\Documents\Thesis\spiral-galaxies\data\Tadaki_Segmentation\set_2\segmentation"]
INPUT_LABELS_LOCATION = "./Tadaki+20_spiral/Tadaki+20_spiral.cat"
OUTPUT_IMAGES_FILE = r"E:\Documents\Thesis\spiral-galaxies\data\Tadaki_Segmentation\set_2_segmentation.dat"
...
def extract_images(input_locations, output_image_location, output_label_location):
    ...
    for idx, input_location in enumerate(input_locations):
        ...
        if not input_path.exists():
            ...
            return -1
        filenames = list(input_path.glob("*.tif"))
